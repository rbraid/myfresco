...
V_W_plot_blur = TH2D("V_W_plot_blur","Comparing Blurred Chi Square of V vs W;V;W", 60,25,85, 21,15,120)
[V_W_plot_blur.Fill(x,y,z) for x, y, z in zip(inFrame["V"], inFrame["W"], inFrame["BlurChiSquare"])]

V_W_plot_prod = TH2D("V_W_plot_prod","Comparing Product of Blurred Chi Square and Regular Chi Square of V vs W;V;W", 60,25,85, 21,15,120)
[V_W_plot_prod.Fill(x,y,z) for x, y, z in zip(inFrame["V"], inFrame["W"], inFrame["BlurChiSquare"] * inFrame["Chi Square"])]

V_W_plot_init = TH2D("V_W_plot_init","Comparing Regular Chi Square of V vs W;V;W", 60,25,85, 21,15,120)
